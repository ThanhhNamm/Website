        ...
        <div class="row justify-content-center text-center">
				<div class="col-md-10 col-lg-8">
					<div class="header-section">
						<h2 class="title"><span>Hoạt động của công ty</span></h2>
						<p class="description" style="padding:30px">Nơi trưng bày những kỉ niệm của tất cả thành viên trong công ty, và cũng là nơi lưu giữ đầy thanh xuân và những dấu mốc quan trọng của Từ Tâm</p>
					</div>
				</div>
			</div>
       <?php
